...
const file_users_proto_rawDesc = "" +
	"\n" +
	"\vusers.proto\x12\x04user\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\"\xb4\x01\n" +
	...
	"\tlast_name\x18\x03 \x01(\tR\blastName2\x80\x03\n" +
	"\vUserService\x12[\n" +
	"\bRegister\x12\x15.user.RegisterRequest\x1a\x16.user.RegisterResponse\" \x82\xd3\xe4\x93\x02\x1a:\x01*\"\x15/api/v1/auth/register\x12T\n" +
	"\fAuthenticate\x12\x11.user.AuthRequest\x1a\x12.user.AuthResponse\"\x1d\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/api/v1/auth/login\x12Z\n" +
	"\n" +
	"GetProfile\x12\x16.google.protobuf.Empty\x1a\x15.user.GetUserResponse\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15/api/v1/users/profile\x12b\n" +
	"\rUpdateProfile\x12\x17.user.UpdateUserRequest\x1a\x16.google.protobuf.Empty\" \x82\xd3\xe4\x93\x02\x1a:\x01*\x1a\x15/api/v1/users/profileB\vZ\t/protobufb\x06proto3"
...
var file_users_proto_depIdxs = []int32{
	...
	2, // 1: user.UserService.Authenticate:input_type -> user.AuthRequest
	6, // 2: user.UserService.GetProfile:input_type -> google.protobuf.Empty
	5, // 3: user.UserService.UpdateProfile:input_type -> user.UpdateUserRequest
	1, // 4: user.UserService.Register:output_type -> user.RegisterResponse
	3, // 5: user.UserService.Authenticate:output_type -> user.AuthResponse
	4, // 6: user.UserService.GetProfile:output_type -> user.GetUserResponse
	6, // 7: user.UserService.UpdateProfile:output_type -> google.protobuf.Empty
